            ...
            <ul className="user-info-list">
              ...
              {photos.user && (
                <li>
                  ...
                  <span className="text-muted">{photos.user.location}</span>
                </li>
              )}
              {photos.user && (
                <li>
                ...
                <li>
                  ...
                  <span className="text-muted">
                    ...
                    photos.user.instagram_username.indexOf(
                      ...
                      >
                        {photos.user.instagram_username.indexOf("/") !== -1
                          ? photos.user.instagram_username.split("/")[3]
              ...
              {photos.user && (
                <li>
                  ...
                  <span className="text-muted">{photos.user.total_photos}</span>
                </li>
              )}
              {photos.user && (
                <li>
                  <strong>Total Likes : </strong>
                  <span className="text-muted">{photos.user.total_likes}</span>
                </li>
              )}
              {photos.user && (
                <li>
